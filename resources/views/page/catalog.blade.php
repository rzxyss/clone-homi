...
<div class="container my-5">
    <div class="col-lg-12 justify-content-center">
        <h1 class="text-center mb-5" style="font-size: 2rem">Katalog</h1>
        <div class="col-md-12">
            <div class="col-md-2 mt-1 d-inline ">
                ...
                <div class="btn-group">
                    <button class="btn btn-sm btn-outline-dark newest" data-sorttype="newest"
                        onclick="sort(this)">Terbaru</button>
                    <button class="btn btn-sm btn-outline-dark oldest" data-sorttype="oldest"
                        onclick="sort(this)">Terlama</button>
                    <button class="btn btn-sm btn-outline-dark best-seller" data-sorttype="best-seller"
                        onclick="sort(this)">Terlaris</button>

                    <div class="btn-group">
                        <button class="btn btn-sm btn-outline-danger dropdown-toggle" id="dropdownPrice"
                            style="font-size: 0.85rem" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            Harga
                        </button>
                        <div class="dropdown-menu" aria-labelledby="dropdownPrice">
                            <button class="dropdown-item high-price" data-sorttype="high-price"
                                onclick="sort(this)">Harga Tertinggi</button>
                            <button class="dropdown-item low-price" data-sorttype="low-price" onclick="sort(this)">Harga
                                Terendah</button>
                        </div>
                    </div>

                    {{-- <div class="btn-group">
                        <button class="btn btn-sm btn-outline-info dropdown-toggle" id="dropdownCategory"
                            style="font-size: 0.85rem" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            Kategori
                        </button>
                        <div class="dropdown-menu" aria-labelledby="dropdownCategory">
                            <button class="dropdown-item modern" data-sorttype="modern"
                                onclick="sort(this)">Modern</button>
                            <button class="dropdown-item vintage" data-sorttype="vintage"
                                onclick="sort(this)">Vintage</button>
                            <button class="dropdown-item skandinavian" data-sorttype="skandinavian"
                                onclick="sort(this)">Skandinavian</button>
                            <button class="dropdown-item tropis" data-sorttype="tropis"
                                onclick="sort(this)">Tropis</button>
                            <button class="dropdown-item klasik" data-sorttype="klasik"
                                onclick="sort(this)">Klasik</button>
                        </div>
                    </div> --}}
                </div>
    ...
    <div class="row col-lg-12 mx-2" id="products">
        ...
        <div class="col-md-3 d-flex justify-content-center">
            <div class="card mb-4" style="width: 18rem;">
                <div class="box_image"
                    style="background-image: url('{{ asset('assets') }}/images/product/{{ $data->image }}')"></div>
                <div class="card-body">
                    @if ($data->discount)
...
<script>
    ...
    function sort(button, page = 1) {
        ...
        $.ajax({
            type: 'GET',
            dataType: 'json',
            url: `catalog-product/sort/${sortType}?page=${page}`, // Include the page parameter in the URL
            success: function (response) {
                if (response) {
                    ...
                    $.each(response.products, function (index, value) {
                        ...
                        var cardHtml = `
                        <div class="col-md-3 d-flex justify-content-center">
                            <a href="{{ asset('produk/${value.id}')}}" class="d-inline position-relative">
                                <div class="card mb-4" style="width: 18rem;">
                                    <span style="z-index:99; font-size:0.75rem" class="p-1 ml-1 mt-1 position-absolute badge badge-notification ${bg}">
                                        ${value.subcategory.subcategory_name}
                                    </span>
                                    <div class="box_image" style="background-image: url('{{ asset('assets') }}/images/product/${value.image.image}">                                        
                                </div>
                            </a>
                                ...
                                <div class="d-flex justify-content-between" >
                                    ...
                                    <div class="d-flex btn-group" style="float: right;">
                                        <div id="cartButton${value.id}">
                                            <button type="button" onclick="cartToggle(${value.id})" class="scale-transition blue-logo btn btn-link">
