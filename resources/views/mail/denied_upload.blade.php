...
<body style="background-color: #e9ecef;">
    <div class="preheader"
        ...
        Permintaan Upload Desain Ditolak Oleh Admin
    </div>
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <h1
                                ...
                                Permintaan Upload Desain Ditolak
                            </h1>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">
                                Mohon Maaf Admin Menolak Perminaan Upload Produk Anda
                                <br>
                                Produk Detail :
                            </p>
                        </td>
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">
                                Silahkan Perbaiki Kesalah Yang Dituliskan Oleh Admin Di Kolom Alasan.
                            </p>
                        </td>
                    </tr>
                    <tr>
