...
<body style="background-color: #e9ecef;">
    <div class="preheader"
        ...
        Pembayaran Pembelian Produk Anda Ditolak Oleh Admin
    </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">
                                Mohon Maaf Pembayaran Pembelian Produk Anda Ditolak.
                                <br>
                                Rincian Pembelian :
                            </p>
                        </td>
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">
                                Silahkan Hubungi Admin Homi Desain Untuk Informasi Lebih Lanjut.
                            </p>
                        </td>
                    </tr>
                    <tr>
